...
//Module Panel
	...
	using.screen_loc = ui_drop_throw_2
	using.layer = 19
	src.adding += using
...
//Store
	...
	mymob.throw_2_icon.screen_loc = ui_swaphand
...
*/
	...
	mymob.client.screen += list( mymob.throw_2_icon, mymob.zone_sel, mymob.oxygen, mymob.fire, mymob.hands, mymob.healths, mymob:cells, mymob.pullin, mymob.blind, mymob.flash) //, mymob.rest, mymob.gun_setting_icon, mymob.sleep, mymob.mach )
